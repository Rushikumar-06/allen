...
function Login() {
  ...
  return (
    <div className="login-background">
        {!otpStatus ? <div className="login-container">
        ...
        />
        <button className={`send-otp-button ${isValidMobile ? 'login-active' : 'login-disabled'}`} onClick={handleOtpSubmit}>Submit</button>
